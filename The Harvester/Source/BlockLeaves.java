...
public class BlockLeaves extends BlockLeavesBase
{
    ...
    {
        if(!world.multiplayerWorld && entityplayer.getCurrentEquippedItem() != null && entityplayer.getCurrentEquippedItem().itemID == Item.shears.shiftedIndex || entityplayer.getCurrentEquippedItem().itemID == mod_Harvester.Harvester.shiftedIndex)
        {
